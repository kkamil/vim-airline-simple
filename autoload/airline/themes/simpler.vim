...
let s:N2 = [ '#ffffff' , '#444444' , s:termbg , 238 ]
...
let s:I2 = [ '#ffffff' , '#444444' , s:termbg , 238 ]
...
let s:V2 = [ '#ffffff' , '#444444' , s:termbg , 238 ]
...
let s:IA2 = [ '#ffffff' , '#444444' , s:termbg , 238 ]
let g:airline#themes#simpler#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA2, s:IA2)
